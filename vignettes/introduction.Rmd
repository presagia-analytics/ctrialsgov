...
**[the data is currently included with the package rather than downloaded]**
...
The package (will) also contain a number of tools for visualizing the output.
Here is one example:
